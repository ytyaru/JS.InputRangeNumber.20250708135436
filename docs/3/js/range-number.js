class HTMLInputRangeNumberElement extends HTMLElement {
    ...
    #set(t,v) {
        //if (this.#setN(t,v) || this.#setS(t,v)) {console.log(t,v);'number range'.split(' ').map(n=>this._.el[n].value=v); return true}
        //if (this.#setN(t,v) || this.#setS(t,v)) {return true}
...
//    this.#setT(t,v,'s',this._.setT.s.is,this._.setT.s.parse);
//    this.#setT(t,v,'n',this._.setT.n.is,this._.setT.n.parse)
//    this.#setT(t,v,'s',(v)=>('string'===typeof v || v instanceof String),(v)=>Number(v))
//    this.#setT(t,v,'n',(v)=>('number'===typeof v && !Number.isNaN(v)),(v)=>v.toString())
    /*
    #setN(t,v) {
